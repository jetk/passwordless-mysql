...
function Store(conString) {
    ...
    this._client = new sqlite3.Database('passwordless');

    this._client.run("CREATE TABLE IF NOT EXISTS " + this._table + " " +
        "(id serial, uid character varying(160), token character varying(60) NOT NULL, origin text, ttl bigint, " +
